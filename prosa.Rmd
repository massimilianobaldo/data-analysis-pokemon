...
Alcune volte sono impiegati nei lavori pubblici, altri nei conscorsi e inifine, l'amibito che interessa a noi, quello delle lotte.  
...
## Obiettivo
L'obiettivo di questa analisi è rispondere a delle domande prefissate che sono state mosse dalla mia curiosità sin da giovane.  
...
## Nota personale
Sin da quando ero ragazzino i pokemon sono sempre stati una ammirazione per me, ho capito solo qualche anno fa qual fosse il vero potenziale di un pokemon e le possibili opportunità che il gioco stesso ti lasciava.  
...
Effettivamente, esiste una sorte di correlazione tra l'aumento di peso e di altezza con gli stats?
...
Si evince che non esiste una correlazione lineare tra l'atezza e il peso verso le statistiche base del pokeomn.  
...
```{r fig.height = 5, fig.width = 10, fig.align = "center"}
# Creiamo i quadrati delle altezze e dei pesi e valutiamo se esiste una corrlezione lineare tra gli stats
...
Utlima osservazione, proviam con una funzione logaritmica
...
Questi grafici dimostrano che esiste una corrlezione diretta tra le altezze e i pesi sottoposti in forma logaritmica, e in questo caso l'attacco del pokemon.  
Possiam dedurre alla fine che essite una correlazione logaritmica tra peso e altezza con l'attacco, la difesa e infine i punti salute. 
...
Secondo i forum per le lotte pokemon in competitiva, per creare una squadra bisogna partitre da un pokemon e analizzare le sue debolezze.  
