...
![Skarmory](./img/skarmory.png){.dream_team style="left: 80%;"}
...
```{r out.extra='class="kable_wrapper"'}
knitr::kable(df_image %>% select(-c0), align = "c", col.names = NULL) %>%
    column_spec(1, image = spec_image(c("./img/azumarill.png", "./img/steelix.png"), 375, 375)) %>%
    column_spec(2, image = spec_image(c("./img/skarmory.png", "./img/mawile.png"), 375, 375)) %>%
    column_spec(3, image = spec_image(c("./img/empoleon.png", "./img/aegislash.png"), 375, 375))
```

## È effettivamnte un dream team?
